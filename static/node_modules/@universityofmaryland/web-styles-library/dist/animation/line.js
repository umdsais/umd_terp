...
const slideUnder = {
    ...
    grayDarkRed: {
      ...
      &:focus > *:not(svg):not(.sr-only)`]: {
        ...
        '& > *:not(svg):not(.sr-only)': getSlideUnderTwoColorStyle(color.gray.dark, color.red),
    },
    grayRed: {
        ...baseStyles.link,
        [`&:hover > *:not(svg):not(.sr-only),
      &:focus > *:not(svg):not(.sr-only)`]: {
        ...
        '& > *:not(svg):not(.sr-only)': getSlideUnderTwoColorStyle(color.gray.light, color.red),
    },
    gold: {
        ...baseStyles.link,
        [`&:hover > *:not(svg):not(.sr-only),
