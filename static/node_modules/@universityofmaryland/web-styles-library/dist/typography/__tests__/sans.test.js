...
describe('typography/sans', () => {
    ...
    describe('transformations', () => {
        it('should have correctly defined transformations', () => {
            expect(sans.transformations.largestUppercase.fontWeight).toBe(font.weight.extraBold);
            expect(sans.transformations.largestUppercase.textTransform).toBe('uppercase');
            expect(sans.transformations.extraLargeUppercase.fontWeight).toBe(font.weight.extraBold);
            expect(sans.transformations.extraLargeUppercase.textTransform).toBe('uppercase');
            expect(sans.transformations.extraLargeBold.fontWeight).toBe(font.weight.bold);
...
//# sourceMappingURL=sans.test.js.map